...
# les classe du model checkpoint entrainer avec les anciens data contenu dans le projet keras-fruit-python
# classes = ["Apricot", "Avocado", "Banana", "Chestnut", "Clementine", "Granadilla", "Kiwi", "Limes",
...
def upload():
    ...
    for upload in request.files.getlist("file"):
        ...
        # new_model = load_model('fruits_checkpoints.h5')
